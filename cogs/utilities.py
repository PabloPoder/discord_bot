...
class Utilities(commands.Cog):
    ...
    async def commands(self, interaction: Interaction):
        ...
        file = discord.File("images/blade-runner-rachael1.gif",
                            filename="blade-runner-rachael1.gif")
    ...
    async def ping(self, interaction: Interaction):
        ...
        logger.info(
            f"Sent pong request from {interaction.user.name} with latency {latency}")
    # endregion
    ...
    async def rlrank(self, interaction: Interaction, nametag: str):
        ...
        view.add_item(RLPlaylistsDropdown(
            playlists=player.playlists, player=player))
